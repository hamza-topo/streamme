<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav slimscrollsidebar">
        ...
        <ul class="nav" id="side-menu">
            ...
            <li>
                <a href="{{route('animes')}}" class="waves-effect"><i class="fa fa-file-video-o fa-fw" aria-hidden="true"></i> @lang('Animes')</a>
            </li>
            <li>
                <a href="{{route('categories')}}" class="waves-effect"><i class="fa fa-table fa-fw" aria-hidden="true"></i> @lang('Categories')</a>
            </li>
            {{--
                    <li>
        ...
        <div class="center p-20">
            <a href="" target="_blank" class="btn btn-danger btn-block waves-effect waves-light">@lang('Logout')</a>
        </div>
    </div>
